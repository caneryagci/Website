document.addEventListener('DOMContentLoaded', function () {
    ...
    const translations = {
        ...
        tr: {
            ...
            "design-header": "Tasarım Yapın.",
            "design-description": "Termavis olarak fikirleri detaylı, yenilikçi tasarımlara dönüştürüyoruz. Ekibimiz, ihtiyaçlarınıza özel hassas mühendislik çözümleri geliştirme konusunda uzmanlaşmıştır. İster termal sistemler ister karmaşık mekanik tasarımlar olsun, her projeyi doğruluk, yaratıcılık ve verimlilikle planlayarak başarılı bir uygulama için temel oluşturuyoruz.",
